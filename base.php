...
<div id="dataform">
	...
	?></select>
		...
		<div id="inputform"><?php echo $_SESSION['user']?><input type="hidden"
				name="petugas" value="<?php echo $_SESSION['user_id']; ?>">
		</div>
		<div id="inputlabel">&nbsp;</div>
		<div id="inputform">
			<input type="submit" value="Simpan" name="tambah" id="savebutton"> <input
				type="button" onclick="batal()" value="Batal" id="cancelbutton">
		</div>
	</form>
</div>
<?php
	...
	?></select>
		...
		<div id="inputform">
			<input type="hidden" name="cash_id"
				...
				value="Simpan" name="perbaiki" id="savebutton"> <input type="button"
				onclick="batal()" value="Batal" id="cancelbutton">
		</div>
	</form>
</div>
<?php
...
<div id="dataform">
	<form method="post">
		...
		<div id="inputform">
			<input type="text" name="flow" value="<?php echo $data['flow']; ?>">
		</div>
		<div id="inputlabel">Keterangan</div>
		<div id="inputform">
		...
		<div id="inputform">
			<input type="hidden" name="flow_id"
				value="<?php echo $_POST['flow_id']; ?>"><input type="submit"
				value="Simpan" name="perbaiki" id="savebutton"> <input type="button"
				onclick="batal()" value="Batal" id="cancelbutton">
		</div>
	</form>
...
<div id="dataform">
	...
	?>
		...
		<div id="inputform">
			<input type="text" name="desc"
				value="<?php echo $ttype['type_desc'] ?>">
		</div>
		<div id="inputlabel">&nbsp;</div>
		<div id="inputform">
