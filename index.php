...
<div id="login">
			...
			<form method="post" action="signin.php">
				...
				<div id="loginform">
					<img src="images/key.png" height="16px" width="16px"> <input
						type="password" name="password"><input type="hidden" name="in"
						value="&lt;?php echo rand(0, 1000000000); ?&gt;">
				</div>
				<p></p>
				<p></p>
				<div id="loginlabel">&nbsp;</div>
				<div id="loginbutton">
					<input type="submit" value="Masuk" id="loginsubmit"> <input
						type="reset" value="Batal" id="loginreset"> <input type="hidden"
						name="in" value="masuk">
				</div>
			</form>
		</div>
