...
<div id="dataform">
	<form method="post">
		<div id="inputlabel">Password saat ini</div>
		<div id="inputform">
			<input type="password" name="existingpass">
		</div>
		<div id="inputlabel">Password baru</div>
		<div id="inputform">
			<input type="password" name="newpass">
		</div>
		<div id="inputlabel">Konfirmasi password</div>
		<div id="inputform">
			<input type="password" name="passconfirm">
		</div>
		<div id="inputlabel">&nbsp;</div>
		<div id="inputform">
			<input type="submit" name="change" value="Ubah" id="savebutton"> <input
				type="button" onclick="toDashboard()" value="Batal"
				id="cancelbutton">
		</div>
	</form>
</div>
